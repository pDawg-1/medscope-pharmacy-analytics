...
-- =========================
-- RAW FILE LANDING OBJECTS
-- =========================

CREATE STAGE IF NOT EXISTS MEDSCOPE_DB.RAW.MEDSCOPE_CSV_STAGE;

CREATE FILE FORMAT IF NOT EXISTS MEDSCOPE_DB.RAW.MEDSCOPE_CSV_FORMAT
    TYPE = CSV
    SKIP_HEADER = 1
